...
| Filtro | Resultado |
|---|---|
| Notebooks escritos | 13 (módulos 0, 1 y 2 completos, con sus dos proyectos) |
| Problemas estáticos | 0 |
| Notebooks que se ejecutan enteros, sin clave y **con la red cortada** | 13 de 13 |
| Intentos de salida a `smith.langchain.com` durante esa ejecución | **0** |
| Pruebas | 102 de 102, con la red cortada también |
