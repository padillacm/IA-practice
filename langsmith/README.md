...
| 2 · Datasets y experimentos | 5 + 1 proyecto | 5 de 6 |
...
| Filtro | Resultado |
|---|---|
| Notebooks escritos | 12 (módulos 0 y 1 completos, módulo 2 en curso) |
| Problemas estáticos | 0 |
| Notebooks que se ejecutan enteros, sin clave y **con la red cortada** | 12 de 12 |
| Intentos de salida a `smith.langchain.com` durante esa ejecución | **0** |
| Pruebas | 99 de 99, con la red cortada también |
...
están en los notebooks 04, 05 y P1, y van señaladas una a una.
